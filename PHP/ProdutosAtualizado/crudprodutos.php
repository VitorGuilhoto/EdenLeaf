<?php 
   ...
   <link rel='stylesheet' type='text/css' href='css/produtosphp.css'>
        </head>";
  ...
  while ($linha = $select->fetch()) {
     ...
     echo" 
        <div class='produto1'>
            <img src='imagens/Rectangle_35.jpg'class='foto'> 
            <div class='p1'><pre>R$$valor                    <strong>$nome</strong></pre></div>
            <div class='p3'>$descricao</div>
            <a href='formProdutos.php?codProduto=$codigoProduto'><img src='imagens/alterar.png' class='edicao'></a><br>
            <a href='excluirProduto.php?codProduto=$codigoProduto'><img src='imagens/excluir.png' class='exclusao'></a><br>
         </div>
  ...
  echo"<center>
    <a href='formProdutos.php'><img src='imagens/adicionar.png' width='50'></a></center><br>
        </div>";
